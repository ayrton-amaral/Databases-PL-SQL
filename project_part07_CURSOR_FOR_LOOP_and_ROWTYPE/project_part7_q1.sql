SPOOL C:\DB2\project_part7\project_part7_q1.txt
SELECT TO_CHAR (sysdate, 'Day DD Month Year HH:MI:SS Am') FROM dual;
SET SERVEROUTPUT ON

-- Question 1
-- Run script 7northwoods in schemas des03
-- Using CURSOR FOR LOOP syntax 1 in a procedure
-- to display all the faculty member (f_id, f_last, f_first, f_rank),
